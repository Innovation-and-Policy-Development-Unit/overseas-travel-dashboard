...
export function AppSidebar({ onClose, years, selectedYear, onYearChange }: Props) {
  return (
    <nav className="flex h-full flex-col bg-un-surface border-r border-un-border w-60">
      ...
      <div className="border-t border-un-border">
        <a
          href="./docs/user-manual.html"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-5 py-2.5 text-[11px] text-un-secondary hover:text-primary hover:bg-un-wash transition-colors"
        >
